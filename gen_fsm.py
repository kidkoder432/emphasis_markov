...
# Add file logging
file_handler = logging.FileHandler("generate_refactored.log", mode="w")
...
DEFAULT_RAGADATA_PATH = "amrit.json"
DEFAULT_SPLINES_PATH = "splines.pkl"
DEFAULT_SWARS_PATH = "swars.json"
OUTPUT_PHRASES_FILE = "phrases.txt"
OUTPUT_MIDI_FILE = "out.mid"
NUM_PHRASES = 25
MIDI_BPM = 100
MIDI_TONIC_NOTE = 56
